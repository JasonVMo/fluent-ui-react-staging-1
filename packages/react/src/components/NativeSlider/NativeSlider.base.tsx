...
export const NativeSliderBase = composable<ISliderProps, ISliderSlotProps>({
  ...
  usePrepareProps: (
    props: ISliderProps,
    useStyling: IUseStyling<ISliderProps, ISliderSlotProps>
  ) => {
    const { slotProps, state } = useSlider({
      ...props,
    ...
    return {
      slotProps: mergeSettings<ISliderSlotProps>(useStyling(props), slotProps),
      state
    };
  },
  // eslint-disable-next-line react/display-name
  render: (
    Slots: ISlots<ISliderSlotProps>,
    _renderData,
