...
import {
  INativeSliderTokens,
  INativeSliderSlotProps
} from "./NativeSlider.types";
import {
  compose,
  IUseComposeStyling,
  IComposeSlots,
...
const TrackRailBase = compose<IMultiTrackRailType>({
  ...
  usePrepareProps: (
    props: IMultiTrackRailProps,
    useStyling: IUseComposeStyling<IMultiTrackRailType>
  ) => {
  ...
  render: (
    Slots: IComposeSlots<IMultiTrackRailType>,
    renderData: IComposeRenderData<IMultiTrackRailType>
  ) => {
...
export const DualNativeSlider = compose<IDualSliderType>(
  {
    ...
    settings: [{ tokens: { barGap: 4, trackSize: 4 } }],
    usePrepareProps: (
      props: ISliderProps,
      useStyling: IUseComposeStyling<IDualSliderType>
    ) => {
      return NativeSlider.__composable.usePrepareProps!(
        props as any,
        useStyling
      );
    }
